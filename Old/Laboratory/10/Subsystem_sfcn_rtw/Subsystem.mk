...
#
# File    : rtwsfcn_lcc.tmf   $Revision: 1.20.4.3 $
#
# Abstract:
...
NCSTATES        = 4
MEM_ALLOC       = RT_STATIC
BUILDARGS       = ADD_MDL_NAME_TO_GLOBALS=1 MODELLIB=Subsystemlib.lib SHARED_SRC= SHARED_SRC_DIR= SHARED_BIN_DIR= MODELREF_LINK_LIBS= SHARED_LIB= RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL     = 1
USERMODULES     =  
USEPARAMVALUES  = 0
...
ADD_INCLUDES = \
	-I"c:\documents and settings\aluno.maq8\meus documentos\lab 8" \
	-I"c:\documents and settings\aluno.maq8\meus documentos\lab 8\subsystem_sfcn_rtw" \
...
clean :
	...
	@del $(OBJS) ..\$(MODEL)_sf.dll $(wildcard *.obj) $(wildcard *.lib)
