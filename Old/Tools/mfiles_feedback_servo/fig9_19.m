%  Figure 9.19      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
%  fig9_19.m is a script to generate Fig 9.19 the transient  
...
title('Fig. 9.19 Closed-loop step response for SRL design with state feedback')
