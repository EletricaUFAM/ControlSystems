%  Figure 9.08      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
% fig9_08.m is a script to generate Fig. 9.8  the         
...
ylabel('Magnitude |D2(s)G(s)|');
loglog(w,ones(size(magol2)),'g');
title('Fig. 9.8 Frequency response of low-gain satellite PD design')
