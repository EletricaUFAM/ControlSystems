%  Figure 9.46      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
% fig9_46.m is a script to generate Fig. 9.46 the step response for the SRL
...
title( 'Fig. 9.46 Outer-loop control for altitude step');
xlabel(' Time (sec)');
ylabel('\delta e (deg)');
grid;
