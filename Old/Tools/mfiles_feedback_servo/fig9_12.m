%  Figure 9.12      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
%  fig9_12.m is a script to generate fig 9.12 
...
ylabel('Magnitude, |KD3(s)G(s)|');
title('Fig. 9.12: Bode plot of KD3(s)G(s)')
subplot(212); 
