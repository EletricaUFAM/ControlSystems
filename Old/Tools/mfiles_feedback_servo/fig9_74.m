%  Figure 9.74      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
% fig9_74.m is a script for disk read/write head control design
...
semilogx(w,magdb1);
grid;
title('Fig. 9.74 Disk drive control with gain-stabilized resonance');
