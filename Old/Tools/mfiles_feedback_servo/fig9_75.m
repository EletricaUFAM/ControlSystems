%  Figure 9.75      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
% fig9_75.m is a script for disk read/write head control design 
...
xlabel('Time (msec)');
ylabel('Amplitude');
title('Fig. 9.75 Step response of disk control with PM = 50')
