%  Figure 7.42      Feedback Control of Dynamic Systems, 4e
...
hold on
plot(ycd(:,1),ycd(:,3),'--')
title('Figure 7.42(a) Output Responses of Digital and Continuous Controllers')
xlabel('Time (sec)');
ylabel('y');
grid on;
...
hold on
plot(ucd(:,1),ucd(:,3),'--')
title('Figure 7.42(b)  Control Responses of Digital and Continuous Controllers')
xlabel('Time (sec)');
ylabel('u');
grid on;
gtext('continuous controller')
