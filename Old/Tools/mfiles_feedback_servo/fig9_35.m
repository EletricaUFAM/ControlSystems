%  Figure 9.35      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
% Fig. 9.35  Script for computation of the yaw damper rootlocus
...
title('Fig. 9.35 Rootlocus for a/c with washout')
