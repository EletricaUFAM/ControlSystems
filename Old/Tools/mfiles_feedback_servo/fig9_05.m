%  Figure 9.05      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
% fig9_05.m is a script to generate Fig. 9.5   
...
axis(v); 
title('Fig. 9.5 Root locus for the PD design of the satellite')
% 
