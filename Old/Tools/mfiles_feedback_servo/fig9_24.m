%  Figure 9.24      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
%   fig9_24.m is a script to generate Fig. 924,   
...
title('Fig. 9.24 Closed-loop step response for the SRL design with an estimator')
