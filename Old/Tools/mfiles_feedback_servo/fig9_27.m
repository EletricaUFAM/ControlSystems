%  Figure 9.27      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
%  fig9_27.m is a script to generate Fig. 9.27, the      
%  step response of the colocated
...
step(sys2,t);
grid;
title('Closed-loop step response for D5(s)Gco(s).')
