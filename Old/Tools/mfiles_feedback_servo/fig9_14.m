%  Figure 9.14      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
%  fig9_14.m is a script to generate Fig. 9.14, the transient 
...
xlabel('Time (sec)');
ylabel('Amplitude');
title('Closed-loop step response of KD3(s)G(s)')
