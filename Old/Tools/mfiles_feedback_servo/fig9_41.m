%  Figure 9.41      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
% fig9_41.m is a script to create Figure 9.41, the step response of the
...
ylabel('\theta (t) (rad)');
grid;
title(' Fig. 9.41 step response of the pitch angle inner loop ')
