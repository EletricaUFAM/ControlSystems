%  Figure 9.16      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
%  fig9_16.m is a script to generate Fig 9.16    
...
ylabel('Magnitude, KD3(s)Ghat(s)|');
title('Fig. 9.16 Frequency response for KD3(s)Ghat(s).')
subplot(212); 
