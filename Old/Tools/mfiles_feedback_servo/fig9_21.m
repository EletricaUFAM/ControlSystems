%  Figure 9.21      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
%   fig9_21.m is a script to generate Fig 9.21, the     
...
ylabel('Magnitude, |D4(j\omega)|');
Title('Fig. 9. 21: Bode plot of the optimal compensator D4(s)');
...
%pause
%bcl=nbar*[g;g];
%subplot(223); step(acl,bcl,ccl,dcl); hold on; step(acl1,bcl,ccl,dcl) 
