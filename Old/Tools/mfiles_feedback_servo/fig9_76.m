%  Figure 9.76      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
% fig9_76.m is a script for disk read/write head control design
...
semilogx(w,magdb1);
grid on;
title('Fig. 9.76 Disk drive control with gain-stabilized resonance and roll-off filter');
