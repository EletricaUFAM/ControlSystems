%  Figure 9.22      Feedback Control of Dynamic Systems, 4e
%                        Franklin, Powell, Emami
%
%   fig9_22.m is a script to generate Fig 9.22,      
...
ylabel('Magnitude, |D4(s)G(s)|');
title('Fig. 9.22 Frequency response for D4(s)G(s). (a) Magnitude')
subplot(212); 
